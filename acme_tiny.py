...
def get_crt(account_key, csr, acme_dir, log=LOGGER, CA=DEFAULT_CA):
    ...
    def _send_signed_request(url, payload):
        ...
        protected["nonce"] = urlopen(CA + "/directory", cafile="trustid.crt").headers['Replay-Nonce']
        ...
        try:
            resp = urlopen(url, data.encode('utf8'), cafile="trustid.crt")
    ...
    for domain in domains:
        ...
        while True:
            try:
                resp = urlopen(challenge['uri'], cafile="trustid.crt")
